...
if vat_invoice:
  ...
  total_cola_ex_vat = get_vat_from_amount_incl(total_cola, VAT_CODE_H)
  total_popcorn_ex_vat = get_vat_from_amount_incl(total_popcorn, VAT_CODE_H)
